...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{orig_version.pdf}
    % \vspace{-2mm}
  \caption{
...
\begin{figure}[tb]
  \centering
    \includegraphics[width=0.6\textwidth]{region.pdf}
    % \vspace{-2mm}
  \caption{
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{flip_version.pdf}
    % \vspace{-2mm}
  \caption{
...
%\subsection{Procrastination is a bliss}
...
\end{tabular}}
\caption{\CaptionTextSize Simulation results. Here $T_b$ denotes the (possibly arbitrary) timebound that the algorithm uses. Note that for our method $T_b = \Tbound$ is the time bound that the algorithm is guaranteed to compute a path in.}
\label{tab:sim_results}
\end{table*}
...
%\begin{subfigure}{0.5\textwidth}
%\centering
%  \includegraphics[width=0.9\linewidth]{pick1.png}
%  \includegraphics[width=0.9\linewidth]{pick2.png}
%  \caption{}
%  \label{fig:success}
%\end{subfigure}
%%\hfill
...
%%  \label{fig:memory}
%%\end{subfigure}
%%    \caption{A sequence of successful pickup of a moving object off of a conveyor}
%    \label{fig:pickup}
%\end{figure}
...
%\subsection{Algorithm Building Blocks}
