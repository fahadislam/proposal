...
\newpage
\begin{abstract}
In many robotic applications, including logistics and manufacturing, robots often operate in semi-structured environments and perform highly repetitive manipulation tasks. Additionaly, large parts of these environments are static most of the time.
...
For (1) we assume that the environment occupancy remains purely static during robot's operation.
...
For (3), it requires planning with time as an additional dimension.
